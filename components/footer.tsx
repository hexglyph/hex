...
export default function Footer() {
  return (
    <footer className="border-t bg-black text-white">
      <div className="flex min-h-[calc(100vh-3.5rem)] w-full flex-row items-center justify-center text-center py-8 md:py-12 px-8">
        <div className="flex flex-col justify-between items-center">
          ...
          <div className="flex space-x-4">
            ...
            <Link href="https://linkedin.com/danielniebraz" className="text-gray-400 hover:text-primary/90">
